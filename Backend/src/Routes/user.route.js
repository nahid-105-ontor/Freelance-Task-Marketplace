...
const { postApply } = require("../Controllers/application.controller");
...
.put(authentication,authorization,authorization("admin","client","freelancer"))
.delete(authentication,authorization("admin","freelancer"),verifyApplicationAccess)
